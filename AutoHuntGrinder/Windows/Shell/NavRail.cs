...
internal static class NavRail
{
    ...
    [
        new(AppWindow.Page.Hunt,     FontAwesomeIcon.Crosshairs, "##ahg_nav_hunt",     L.Shell.NavHunt),
        new(AppWindow.Page.Settings, FontAwesomeIcon.SlidersH,   "##ahg_nav_settings", L.Shell.NavSettings),
    ...
    public static AppWindow.Page? Draw(AppWindow.Page current, Plugin plugin)
    {
        ...
        var indicator = Motion.Approach(Motion.Key("##ahg_rail_indicator"), selectedIndex, 16f);
