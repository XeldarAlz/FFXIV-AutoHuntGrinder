...
// console instead of digging the [AHG] lines out of dalamud.log. IPC callbacks and file loads log
...
public static class RunLog
{
    ...
    {
        Svc.Log.Warning(exception, $"{AhgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error($"{AhgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error(exception, $"{AhgConstants.LogPrefix} {message}");
