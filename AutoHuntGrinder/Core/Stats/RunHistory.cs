...
internal sealed class RunHistory
{
    ...
    private void Load()
    {
        ...
        {
            Svc.Log.Warning(exception, $"{AhgConstants.LogPrefix} RunHistory load failed; starting empty");
        }
    }
    ...
    private void Save()
    {
        ...
        {
            Svc.Log.Warning(exception, $"{AhgConstants.LogPrefix} RunHistory save failed");
        }
    }
