...
internal static unsafe class AchievementReader
{
    ...
    // -1 until the first RequestLoad goes out.
    ...
    // True when a request went out. A request already answered or still waiting is never repeated.
    ...
    // True when a request went out; false while another one is still waiting for its answer.
